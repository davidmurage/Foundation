...
export default function AdminStudents() {
  ...
  const fetchRows = async () => {
    ...
    try {
      ...
      const res = await axios.get(`${API_URL}/api/admin/students?${params.toString()}`, {
  ...
  return (
    <div>
      ...
      <div className="admin-filterbar">
        ...
        <button onClick={onApply} disabled={loading}>Filter</button>
      </div>
        ...
        <table className="admin-table">
          ...
          <tbody>
            {rows.map(r => (
              <tr key={r.userId}>
                <td>
                  {r.photo ? <img src={r.photo} alt="" className="mini-avatar" /> : "—"}
                </td>
                <td>
